...
and cmake -B $BUILD_DIR -DCMAKE_TOOLCHAIN_FILE=conan_toolchain.cmake -DCMAKE_BUILD_TYPE=$BUILD_TYPE

# build
and cmake --build $BUILD_DIR $argv

# create './compile_commands.json'
# which helps editors and IDEs
# finding source files:
and cmake --build $BUILD_DIR --target CopyCompileCommands
