...
const std::vector<QString> tips = {
	...
	(QStringList {
		...
		"There is actually a competition (just google around - you will find it!), that awards a price of 1 Million Dollars for the person who succeeds in finding the frequency that makes the devil appear.",
		...
		"2. Sign a contract with him, that binds the devil to make you to win the aforementioned competition"
	}).join("\n"),
	(QStringList {
		"# Sinusoids",
		"",
		"Linguists claim that the word \"Sinus\" etymologically is rooted in Latin and is supposed to mean a fold in garment or figuratively sometimes refers \"Bosom\" or \"Gulf\" in the sense of \"The Bosom of the Sea\". In Anatomy, it refers to an arc or cavity of the body, such as in \"Sinus Urogenitalis\".",
